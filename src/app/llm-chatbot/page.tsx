            ...
            <div className="relative">
              <div className="relative h-[400px] bg-[#0f1313] rounded-lg overflow-hidden border border-[#2a2e2e] flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-400">AI Chatbot Interface</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          <p className="text-lg text-gray-300 leading-relaxed mb-8">
            {project.description} This project showcases advanced AI integration and real-time 
            communication capabilities. Built with modern web technologies, it demonstrates 
            expertise in machine learning APIs and user experience design.
          </p>
